...
def generate_problem(name, number_agents, problem_size, use_reservation = False, eps = 1e-5, max_iter = -1, fixed_iterations = True):
    ...
    placeholders['fixed_iterations'] = ' -fi 1' if fixed_iterations else ''
